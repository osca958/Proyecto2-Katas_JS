...
console.log("Canciones de rock de más de 5 minutos:", rockPlaylist);

// otra forma de hacerlo con metodo filter()

const soloRock = songs.filter(
  (song) => song.genre.toLowerCase().includes("rock") && song.duration > 5,
);

console.log("Canciones de rock de más de 5 minutos:", soloRock);
