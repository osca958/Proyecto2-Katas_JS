/*
Dada una lista de álbumes de música, utiliza un bucle para sumar todas las duraciones solo de los álbumes
de rock y luego imprime el total de estas duraciones por consola.
*/
const albums = [
...
for (const album of albums) {
    if(album.genre.toLowerCase().includes("rock")){
        duracionTotal += album.duration;
    }
}

console.log("El total de duración de todos los albumes de rock es:", duracionTotal);